...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // echo "Class: $class<br>";
    // echo "Date: $date<br>";
    $sql3 = "SELECT * FROM attendance WHERE courseId = '$courseId' AND year = '$year' AND shift = '$shift' AND day = '$date'";
    ...
    if($count > 0){
        echo '<script>
                    alert("Already attendance submitted");
...
<body>
    <div class="relative">
        ...
        <div class="p-6 bg-white/80 shadow-lg rounded-lg w-9/12 mx-auto mt-10">
            ...
            <!-- Attendance Form -->
            <form action="confiq/submitAttendanceCon.php" method="POST">
            ...
            <input type="hidden" name="date" value=<?php echo ($date) ?>>
                ...
                <div class="text-center mt-6">
                    <button type="submit" class="btn btn-info text-lg">Submit Attendance</button>
                </div>
            </form>
        </div>
    </div>
